...
public class ObstacleController : MonoBehaviour
{
	...
	void Update ()
	{
		...
		_textGameObject.transform.rotation = Quaternion.LookRotation(_initializer.Forward, playerCamera.transform.up);
	}
	...
	public void Initialize(ObstacleInitializer initializer)
	{
		...
		var mesh = new Mesh
		{
			vertices = initializer.Vertices,
			triangles = initializer.Triangles
		};
